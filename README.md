...
[ninny](https://github.com/kag0/ninny-json) | JSON library with type classes that allow differentiation between fields with null values and fields which are absent | ![GitHub stars](https://img.shields.io/github/stars/kag0/ninny-json) ![GitHub commit activity](https://img.shields.io/github/commit-activity/y/kag0/ninny-json)
